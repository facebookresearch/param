...
from param.comp.python.tools.validate_trace import TraceValidator
...
class TestTraceLoadAndValidate(unittest.TestCase):
    ...
    def _test_and_validate_trace(self, trace_file):
        with gzip.open(trace_file, "rb") if trace_file.endswith("gz") else open(trace_file, "r") as execution_data:
    ...
    def test_trace_load_resnet_1gpu(self):
        et_file = os.path.join(self.trace_base, "1.0.3-chakra.0.0.4/resnet_1gpu_et.json.gz")
