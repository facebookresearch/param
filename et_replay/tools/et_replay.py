...
from param.comp.et_replay_utils import (
    build_fbgemm_func,
...
from param.utility import trace_handler
from param.comp import pytorch as workloads_pytorch
...
class ExgrReplayManager:
    def __init__(self):
        ...
        try:
            from param.comp.fb.internals import (
                add_internal_label,
